    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Intranets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Intranets_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemsOwnedByCompany", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemsOwnedByCompany_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ranks_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BorrowingEndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    History = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EmployeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ItemOwnedByCompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Borrows_ItemsOwnedByCompany_ItemOwnedByCompanyId",
                        column: x => x.ItemOwnedByCompanyId,
                        principalTable: "ItemsOwnedByCompany",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Borrows_ItemOwnedByCompanyId",
                table: "Borrows",
                column: "ItemOwnedByCompanyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Intranets_CompanyId",
                table: "Intranets",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemsOwnedByCompany_CompanyId",
                table: "ItemsOwnedByCompany",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Ranks_EmployeeId",
                table: "Ranks",
                column: "EmployeeId");
        }
